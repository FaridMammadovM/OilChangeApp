...
namespace Infrastructure.Tokens
{
    public class TokenService //: ITokenService
    {
        ...
        public TokenService(IOptions<TokenSettings> options, UserManager<Customers> userManager)
        {
            tokenSettings = options.Value;
            this.userManager = userManager;
        }
        public async Task<JwtSecurityToken> CreateToken(Customers user, IList<string> roles)
        {
